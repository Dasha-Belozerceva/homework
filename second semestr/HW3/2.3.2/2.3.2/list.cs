...
namespace TemplateOfList
{
    public class List
    {
        ...
        public void InsertElementToHead(string value)
        {
        ...
        /// </summary>
        /// <param name="value">value of this element</param>
        public void InsertElementToTail(string value)
        {
        ...
        public void InsertElementToPosition(string value, int position)
        {
        ...
        /// <returns></returns>
        public bool availabilityOFValue(string value)
        {
            ListElement currentElement = head;
